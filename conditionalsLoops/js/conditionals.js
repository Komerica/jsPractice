...
//setWeather -> reference to the function, it sits this in waiting for that event
//              ,and When the button clicks, then it invokes the function
//setWeather() -> this is calling or invoking the function
...
function setWeather() {
  ...
  if (choice !== "rainy" || choice !== "windy") {
    comments.textContent += " No sign of rain nor wind.";
  }
...
coffeeBreak
  ? (breakMessage.textContent = "Breaktime!")
